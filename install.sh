...
brew install python@3.13 pipx node go gh git-lfs tree cmake make ffmpeg graphviz imagemagick slackdump jupyterlab ipython nginx certbot neovim starship zoxide fzf zsh-autosuggestions tmux tailscale
